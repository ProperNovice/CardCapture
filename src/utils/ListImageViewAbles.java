...
public class ListImageViewAbles<T> implements Iterable<T> {
	...
	protected CoordinatesList coordinatesList = null;

	public ListImageViewAbles(CoordinatesList coordinates) {
	...
	public ListImageViewAbles(CoordinatesList coordinates, int capacity) {
