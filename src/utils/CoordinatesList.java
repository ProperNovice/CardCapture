...
public class CoordinatesList {
	...
	public CoordinatesList(double x, double y, double width, double height, double gapX, double gapY,
			int objectsPerRow, RearrangeTypeEnum rearrangeTypeEnum, DirectionEnum directionEnumHorizontal,
	...
	public NumbersPair getCoordinate(int index) {
		...
		if (this.list != null && !this.list.isEmpty()) {
			...
			this.width = imageViewAble.getImageView().getWidth();
			this.height = imageViewAble.getImageView().getHeight();
